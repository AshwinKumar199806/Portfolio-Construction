...
def main():
    ...
    if st.button('Go to the Github Repository where the code is built'):
        js = "window.open('https://docs.bokeh.org/en/latest/docs/releases.html')"  # New tab or window
        js = "window.location.href = 'https://docs.bokeh.org/en/latest/docs/releases.html'"  # Current tab
